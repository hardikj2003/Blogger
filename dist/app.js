...
var _require = require('./middleware/authentication'),
  checkForAuthenticationCookie = _require.checkForAuthenticationCookie;
var app = express();
...
app.get('/search', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var searchQuery, results;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          searchQuery = req.query.query; // Get the search query from request parameters
          _context2.prev = 1;
          _context2.next = 4;
          return Blog.find({
            $or: [{
        ...
        case 8:
          ...
          console.error('Error searching blogs:', _context2.t0);
          res.status(500).json({
